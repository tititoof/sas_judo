        ...
        <nav>
          <ul class="list-inline">
            ...
            <template v-if="isAdmin">
                ...
                <li class="pull-right">
                    <router-link :to="{ name: 'admin_resultats_index' }">Résultats</router-link>
                </li>
                <li class="pull-right">
                    <router-link :to="{ name: 'admin_age_categories_index' }">Cat&eacute;gories d'&acirc;ge</router-link>
                </li>
                <li class="pull-right">
                    <router-link :to="{ name: 'inscriptions_index' }">Inscriptions</router-link>
                </li>
            </template>
          </ul>
        </nav>
